        ...
        that.show = function (prevAnim) {
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '</div><div class="dwwo"></div></div><div class="dwwol appBordercolor"></div></div></td>';
                    l++;
                }
                html += '</tr></table></div></div>';
            }
            html += (s.display != 'inline' ? '<div class="dwbc appBordercolor' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span style="color:#000" class="dwb  appbackground" >' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb "  style="color:#000">' + s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
