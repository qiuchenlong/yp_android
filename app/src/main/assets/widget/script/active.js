...
app.controller('activeList',['$scope',function($scope){
	...
	function getData(page,callback){
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Activity/getMyActivity',{
			values:{
				user_id:userid,
				type:index,
				page:page
...
app.controller("enrollData",["$scope",function($scope){
	...
	$scope.enrolls = function(id,type,e){
		...
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Activity/ShenHe',{
			values:{
				signup_id:id,
				type:type
			}
	...
	function getData(page,callback){
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Activity/getBaoList',{
			values:{
				user_id:userid,
...
app.controller("recommendedActivities",["$scope",function($scope){
	...
	$scope.zan = function(dynamicid,index){
		...
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/CircleTalk/addLike',{
			values:{
				user_id:userid,
	...
	$scope.attentions = function(id,index){
		...
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Activity/addFriend',{
			values:{
				user_id:userid,
				touserid:id 
			}
...
//					loop: true
	...
	function getData(page,callback){
		...
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Activity/getHotActivity',{
			values:{
				page:page,
...
//					$api.noDate();
	...
	function getData1(page,callback){
		...
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/Topic/getHotTopic',{
			values:{
				page:page
			}
		},function(ret){
...
//					$api.noDate();
	...
	function getData2(page,callback){
		...
		var lon = site.lon;
		var lat = site.lat;
		$api.post('http://www.youdingb.com/zihuijia/index.php/Api/CircleTalk/getHotTalk',{
			values:{
				page:page,
				lon:lon,
				lat:lat,
